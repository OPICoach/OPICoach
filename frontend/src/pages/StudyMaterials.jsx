  ...
  return (
    <div className="flex flex-row h-screen">
      ...
      <div className="flex flex-col w-full bg-white">
        <div className="flex-1 overflow-y-auto px-10 py-8 border-b border-gray-200">
          <h2 className="text-2xl font-semibold mb-4">Study Materials</h2>
          <p className="text-gray-800 leading-relaxed whitespace-pre-line">
            In today's lesson, we discussed how to introduce yourself in various situations.
            The key expressions included: "Let me introduce myself", "I am currently working at...", 
            and "In my free time, I enjoy...".

            Additionally, we learned how to adjust tone depending on formality level.
